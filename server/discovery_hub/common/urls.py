...
from discovery_hub.common import views as common_views
from discovery_hub.core import urls as core_urls
...
schema_view = get_schema_view(
    openapi.Info(
        title="discovery_hub API",
        default_version="1.0",
        description="discovery_hub Docs",
