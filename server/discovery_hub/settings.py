...
SERVER_EMAIL = config("DEFAULT_FROM_EMAIL", default="discovery_hub <noreply@discovery_hub.com>")
...
#
HEROKU_APP_NAME = config("HEROKU_APP_NAME", default="discovery_hub-staging")
...
TEMPLATES = [
    {
        ...
        "DIRS": [
            ...
            os.path.join(BASE_DIR, "discovery_hub", "client", "templates"),  # Swagger template override
        ],
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PAGINATION_CLASS": "discovery_hub.core.pagination.PageNumberPagination",
...
if config("USE_AWS_STORAGE", cast=bool, default=False) and not IS_REVIEW_APP:
    ...
    DEFAULT_FILE_STORAGE = "discovery_hub.utils.storages.PrivateMediaStorage"
    # STATICFILES_STORAGE = "discovery_hub.utils.storages.StaticRootS3Boto3Storage"
...
LOGGING = {
    ...
    "loggers": {
        ...
        "discovery_hub.request": {"handlers": [], "level": "INFO", "propagate": True},
        "discovery_hub.tasks": {"handlers": [], "level": "INFO", "propagate": True},
    },
}
...
if IN_PROD or ROLLBAR_ACCESS_TOKEN:
    ...
    LOGGING["loggers"]["discovery_hub"]["handlers"].append("rollbar")

# Popular testing framework that allows logging to stdout while running unit tests
TEST_RUNNER = "django_nose.NoseTestSuiteRunner"

CORS_ALLOWED_ORIGINS = ["https://discovery-hub-staging.herokuapp.com", "https://discovery-hub.herokuapp.com"]
...
AT_COURSES_TABLE = config("AT_COURSES_TABLE")

GRAPHENE = {
    "SCHEMA": "discovery_hub.core.schema.schema",
    "MIDDLEWARE": [
